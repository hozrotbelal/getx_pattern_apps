...
//       bool? isValidNum = await PhoneNumberUtil.isValidNumber(phoneNumber: widget.initialValue!.phoneNumber!, isoCode: widget.initialValue!.isoCode!);
//       if (widget.initialValue!.phoneNumber != null && widget.initialValue!.phoneNumber!.isNotEmpty && isValidNum!) {
...
//       return Container(
//         height: 36,
//         decoration: BoxDecoration(color: Colors.white, border: Border.all(color: colorLightGray3, width: .5), borderRadius: const BorderRadius.only(topLeft: Radius.circular(5.0), bottomLeft: Radius.circular(5.0))),
//         child: FlatButton(
//           key: const Key(TestHelper.DropdownButtonKeyValue),
...
//             child: Item(country: country, showFlag: selectorConfig.showFlags, useEmoji: selectorConfig.useEmoji, textStyle: const TextStyle(color: colorLightGray3) //selectorTextStyle,
//                 ),
//           ),
//         ),
//       );
